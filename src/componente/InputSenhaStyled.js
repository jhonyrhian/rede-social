...
const InputStyled = styled.input.attrs({ type: "password" })`
    ...
    border-color: ${props => {if(props.cor[0] =='0' && props.cor[1] == '0'){return `#111111`}}};
    ...
    &::placeholder{
        color: ${props => {return `${(props.cor[0] == '0')? `${cores[props.cor[1]]}f1`: `${cores[props.cor[1]]}80`}`}};
        color: ${props => {if(props.cor[0] =='0' && props.cor[1] == '0'){return `#11111199`}}};
    }
    &:focus{
        outline: solid red 1px;
        outline-color: ${props => {return `${cores[props.cor[1]]}`}};
        outline-color: ${props => {if(props.cor[0] =='0' && props.cor[1] == '0'){return `#111111`}}};
        background-color: ${props => {if(props.cor[0] =='0' && props.cor[1]){return `${cores[props.cor[1]]}40`}}};
        background-color: ${props => {if(props.cor[0] =='0' && props.cor[1] == '0'){return `#11111140`}}};
